...
CELL_VOLTAGES_WHILE_CHARGING         = [3.55, 3.48, 3.45, 3.30]
MAX_CHARGE_CURRENT_CV                = [   0,    2,  30,  70]

CELL_VOLTAGES_WHILE_DISCHARGING      = [2.70, 2.80, 2.90, 3.10]
MAX_DISCHARGE_CURRENT_CV             = [   0,    5,  30,  80]
...
MAX_DISCHARGE_CURRENT_T              = [ 0, 28, 80, 80, 28,   0]
