...
class DbusHelper:
    ...
    def setup_instance(self):
        ...
        settings = {
            ...
            # 'CellVoltageMin': [path + '/CellVoltageMin', 2.9, 0.0, 5.0], 
...
#	    self.battery.manage_discharge_current()
    ...
    def publish_dbus(self):
        ...
        # Charge (control) max current
        self._dbusservice['/Info/MaxChargeCurrent'] = self.battery.control_charge_current
#	self._dbusservice['/Info/MaxChargeCurrent'] = self.battery.max_battery_charge_current
        self._dbusservice['/Info/MaxDischargeCurrent'] = self.battery.control_discharge_current
#	self._dbusservice['/Info/MaxDischargeCurrent'] = self.battery.max_battery_discharge_current
