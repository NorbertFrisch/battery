...
CELL_VOLTAGES_WHILE_CHARGING         = [3.55, 3.50, 3.44, 3.43, 3.39]
MAX_CHARGE_CURRENT_CV                = [   0,    5,  8,   40,   80]

CELL_VOLTAGES_WHILE_DISCHARGING      = [2.70, 2.80, 2.90, 3.0, 3.20]
MAX_DISCHARGE_CURRENT_CV             = [   0,    5,  10,   40,  90]
...
MAX_CHARGE_CURRENT_T                 = [ 0, 28, 80, 80, 28, 0]

TEMPERATURE_LIMITS_WHILE_DISCHARGING = [55, 40,  35,   5,  0, -20]
MAX_DISCHARGE_CURRENT_T              = [ 0, 28, 90, 90, 28,   0]
...
CC_CURRENT_LIMIT1 = 9
CC_CURRENT_LIMIT2 = 17
CC_CURRENT_LIMIT3 = 35
CC_CURRENT_LIMIT4 = MAX_BATTERY_CHARGE_CURRENT
CC_CURRENT_LIMIT5 = 17
...
CVCM_ENABLE = False
# Connection restistance per cell to adjust cell voltage depending on current in Ohm
CellConectionResistance=0.001
